    ...
    return (
      <Container style={{backgroundColor:"white"}}>
        <div className="App" tabIndex="1" onKeyUp={this.handleKeyUp}>
          <Name className="text-center" style={{fontFamily: "Times New Roman Times serif",textDecoration:"underline"}}>Hangman</Name>
          <SubTitle className="text-center" newGame={this.state.newGame} style={{fontFamily: "Times New Roman Times serif"}}>Guess the movie</SubTitle>
